...
export const Layout = ({}: ClockProps) => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div
        className="absolute bottom-20 right-20 w-96 h-96 bg-secondary/15 rounded-full blur-3xl animate-float"
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        >
          {[
            ...
            <div
              key={city.tz}
              className="card-gothic p-4 text-center hover:bg-card/80 transition-colors cursor-pointer group"
            >
