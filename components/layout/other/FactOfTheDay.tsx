...
export const FactOfTheDay = () => {
  ...
  return (
    <motion.div
      ...
      className="card-glow p-6 relative overflow-hidden hover:bg-card/80 transition-colors group"
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="p-2 rounded-full bg-secondary/20 hover:bg-secondary/30 transition-colors disabled:opacity-50"
          >
            <motion.div
        ...
        {loading ? (
          ...
          <div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-sm text-foreground leading-relaxed mb-3 group-hover:text-white transition-colors">
                  {currentFact.text}
                </p>
