...
export const metadata: Metadata = {
  ...
  description: "A dark, animated time dashboard with multiple clock styles, weather, and rotating facts.",
  keywords: [
    "clock",
    "time",
    "dashboard",
  ...
  openGraph: {
    ...
    siteName: "Nightfall",
    images: [{ url: "/banner.png", width: 1200, height: 630, alt: "Nightfall" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
